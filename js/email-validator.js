...
const EDEN_API_KEY = "pubkey-83a6-sl6j2m3daneyobi87b3-ksx3q29";
var running = false;
var cache = {};
function validate_email(address_text, in_progress_cb, success_cb, error_cb){
    ...
    var options = {
        ...
        in_progress: in_progress_cb,
        success: success_cb,
        error: error_cb,
    };

    run_validator(address_text, options, cache);
}
